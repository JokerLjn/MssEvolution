...
public class Analyze
{
    ...
    private static String CASE1_INPUT_MS_PATH = "function_decompose/case1/";
    private static String CASE2_INPUT_MS_PATH = "function_decompose/case2/";
    ...
    private static String CASE1_OUTPUT_PATH = "src/main/resources/function_decompose/case1/";
    private static String CASE2_OUTPUT_PATH = "src/main/resources/function_decompose/case2/";

    public Analyze() {}

    public Analyze(String path) {
        CASE1_INPUT_MS_PATH = path + "case1/";
        CASE2_INPUT_MS_PATH = path + "case2/";
        CASE1_OUTPUT_PATH = "src/main/resources/" + path + "case1/";
        CASE2_OUTPUT_PATH = "src/main/resources/" + path + "case2/";
    }
    ...
    public void analyze(int caseNum, int choice) throws IOException, URISyntaxException {
        ...
        // get ms data
        JSONArray services = JSON.parseArray(FileUtils.readFile(inputMsPath));
        ...
        // note : change to compute by microservice interface
    ...
    private Microservice generateMs(ClassDiagram classDiagram, JSONObject service) {
        ...
        // set class
        Set<UmlClass> umlClassSet = new HashSet<>();
        JSONArray classList = service.getJSONArray("classSet");
        for (int i=0; i<classList.size(); i++) {
            UmlClass temp = getClass(classDiagram, getClassName(classList.getString(i)));
            if (temp != null) {
                umlClassSet.add(temp);
            }
        }
        ms.setClassList(new ArrayList<>(umlClassSet));
